...
class Config:
    ...
    # Output naming
    output_filename: str = 'tcn_model_gazecom_BATCH-2048_EPOCHS-25_movement_type.csv'
...
class Paths:
    ...
    model_pattern: str = 'tcn_model_gazecom_BATCH-2048_EPOCHS-25_FOLD-{fold}.pt'
...
class EnsemblePredictor:
    ...
    def _create_model(self):
        ...
        return TCN(input_size=self.config.input_size, 
    ...
    def _load_from_state_dicts(self, state_dicts: List[dict]):
    ...
    def _load_models(self, model_paths: List[Path]):
