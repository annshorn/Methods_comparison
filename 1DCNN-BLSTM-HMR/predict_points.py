"""
Eye Movement Type Classification using CNN-BLSTM Ensemble (GPU-enabled)

This script processes raw gaze data and classifies eye movements using
a pre-trained CNN-BLSTM ensemble with majority voting.
"""
...
class Config:
    ...
    # Output naming
    output_filename: str = 'cnn_blstm_model_hmr_BATCH-8192_EPOCHS-25_movement_type.csv'
...
class Paths:
    ...
    model_pattern: str = 'cnn_blstm_model_hmr_BATCH-8192_EPOCHS-25_FOLD-{fold}.pt'
...
class EnsemblePredictor:
    ...
    def _create_model(self) -> CNN_BLSTM:
        ...
        return CNN_BLSTM(
            ...
            blstm_layers=self.config.blstm_layers  # Changed from lstm_layers
        )
    
    def _load_from_state_dicts(self, state_dicts: List[dict]) -> List[CNN_BLSTM]:
    ...
    def _load_models(self, model_paths: List[Path]) -> List[CNN_BLSTM]:
    ...
    def _predict_single_model(
        ...
        with torch.no_grad():
            for X_batch, _ in loader:
                ...
                # CRITICAL: Transpose for Conv1D
                # From [batch, timesteps, features] -> [batch, features, timesteps]
...
def process_folder(
    ...
    try:
        ...
        rawgaze['Pattern'] = 3  # Required for preprocessor
...
def main():
    ...
    try:
        ...
        config_dict = {
            ...
            'blstm_layers': config.blstm_layers, 
